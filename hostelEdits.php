     ...
     <div class="container">
       ...
       <form method="post" action="updateHostel.php" enctype="multipart/form-data">
         ...
         <div class="form-group">
           ...
           <input type="tel" class="form-control"    value="  <?php echo $row['tel_number'];?>"name="tel_number" autocomplete="off" required>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
           ...
           <input type="text" class="form-control"    value="  <?php echo $row['amenities'];?>" name="amenities" required>
         </div>
         <div class="form-group">
           <label>Images</label>
           <input type="file" class="form-control" name="pictures" accept="Images/*" value="<?php echo  $row['pictures'];?>" required>
         </div><br>
